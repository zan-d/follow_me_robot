...
xterm -fa monaco -fs 13 -bg black -fg white -e "ros2 run follow_me obstacle_detection_node;/bin/bash" &
xterm -fa monaco -fs 13 -bg black -fg white -e "ros2 run follow_me tracking_node;/bin/bash" &
xterm -fa monaco -fs 13 -bg red -fg white -e "ros2 run action action_node;/bin/bash" &
